$.ajaxSetup({ cache: false });//キャッシュを使用しない
			...
			$(function () {
				$.ajax({
					...
					url: "https://www.kanamic.net/common/data/jisseki.json", //取得元のURLまたはディレクトリを記載
					type: 'GET',
					cache: false,
  					dataType: 'json',
					...
					success: function (data) {
							...
							// いつ時点で
							$(".point-box").html(data[0].point);//0000年0月時点
							$(".point-box-en").html(data[0].point);//November 2023
