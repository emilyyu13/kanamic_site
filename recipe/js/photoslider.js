...
FOTO.Slider = {
	...
	thumbClick: function(ev){
		...
		if(this.data[key]['currentId'] != null){
			...
			SKEL.EFFECTS.Slide.animate($('.photoslider_thumb[imageid='+this.data[key]['currentId']+']'),'top','10px','0px',500,SKEL.Transitions.quadOut);
		...
		this.data[key]['intervalThumb'] = SKEL.EFFECTS.Slide.animate(thumb,'top','0px','10px',250,SKEL.Transitions.quadOut);
