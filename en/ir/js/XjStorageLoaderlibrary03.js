...
(function() {
	...
	XjStorageLoaderNews = function(s)
	{
		var defaults =
		{
			...
			len:'',
			documents_all:'',
			documents_Yuho:'99,105,106,107,108,1120,1130,1140,1150,1160,1170',
			documents_Other:'1030,1040,1080,1090,1100,1135,1136,1180,1190,1200,1210,1220,1230,1235,1236,1240,1250,1260,1270,1280,1290,1300,1310,1320,1350,1360'
		};
	...
	XjStorageLoaderNews.prototype.show = function()
	{
		...
		$.getJSON ( url, function ( data )
		{
			...
			if ( data.items )
			{
				...
				$.each ( data.items, function ( i, item )
				{
					...
					if ( ( '' == self.fdate || !self.fdate ) )
					{
						...
						if ( -1 != self.ary_doc_Yuho.indexOf ( item.disclosureCode ) &&
								j1 < 0 )
						{
							return true ;
						}
			...
			if ( '' == cont_yuho )
			{
				cont_yuho += '<dd class="nodate">ただいま掲載すべき事項はございません。</dd>' ;
			}
			...
			$('#xj-mainlist-yuka').append ( cont_yuho ) ;
