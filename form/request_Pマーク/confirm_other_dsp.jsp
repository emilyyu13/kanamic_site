 ...
 <div class="mailForm">
  <div class="formBox pkg corporateName">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.CORPORATENAME)) %></p>
   </div>
  </div>
  <div class="formBox pkg yourName">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.CHARGENAME)) %></p>
   </div>
  </div>
  <div class="formBox pkg mailAddress">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.MAIL)) %></p>
   </div>
  </div>
  <div class="formBox pkg city">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.CITY)) %></p>
   </div>
  </div>
  <div class="formBox pkg phoneNumber">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.TEL)) %></p>
   </div>
  </div>
  <div class="formBox pkg formSubject">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.OTHER.INQUIRY)) %></p>
   </div>
  </div>
...
<form name="confirm" action="./complete.jsp" method="post">
 ...
 <div class="agreement">
  ...
  <button class="submit-button" onclick="javascript:ctrlAction('./complete_other.jsp'); return false;">送信する</button><br><br>
...
<input type="hidden" name="<%=Params.OTHER.CORPORATENAME %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.CORPORATENAME)) %>" />
<input type="hidden" name="<%=Params.OTHER.CHARGENAME %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.CHARGENAME)) %>" />
<input type="hidden" name="<%=Params.OTHER.MAIL %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.MAIL)) %>" />
<input type="hidden" name="<%=Params.OTHER.CITY %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.CITY)) %>" />
<input type="hidden" name="<%=Params.OTHER.TEL %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.TEL)) %>" />
<input type="hidden" name="<%=Params.OTHER.INQUIRY %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.OTHER.INQUIRY)) %>" />
