...
<a href="https://www.kanamic.net/ir/toiawa.html">IRに関するお問合せはこちらをご覧ください。</a></p>
...
<p>当社が保有しているお客さまの個人情報の開示・訂正・利用停止（以下「開示等」といいます。）を請求される場合に関しては、「個人情報の開示・訂正・利用停止をご請求される場合の手続きについて」(<a href="https://www.kanamic.net/pdf/privacy_demand.pdf">https://www.kanamic.net/pdf/privacy_demand.pdf</a>)のとおりといたします。</p>
<h3>※お客様へのお願い</h3>
<ol>
