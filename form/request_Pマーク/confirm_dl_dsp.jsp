 ...
 <div class="mailForm">
  <div class="formBox pkg corporateName">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.CORPORATENAME)) %></p>
   </div>
  </div>
  <div class="formBox pkg yourName">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.CHARGENAME)) %></p>
   </div>
  </div>
  <div class="formBox pkg mailAddress">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.MAIL)) %></p>
   </div>
  </div>
  <div class="formBox pkg city">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.CITY)) %></p>
   </div>
  </div>
  <div class="formBox pkg phoneNumber">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.TEL)) %></p>
   </div>
  </div>
  <div class="formBox pkg formSubject">
   ...
   <div class="formContent">
    <p class="entryChk"><%=DoText.purgeNull(request.getParameter(Params.DL.INQUIRY)) %></p>
   </div>
  </div>
...
<form name="confirm" action="" method="post">
 ...
 <div class="agreement">
  ...
  <button class="submit-button" onclick="javascript:ctrlAction('./complete_dl.jsp'); return false;">送信する</button><br><br>
...
<input type="hidden" name="<%=Params.DL.CORPORATENAME %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.CORPORATENAME)) %>" />
<input type="hidden" name="<%=Params.DL.CHARGENAME %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.CHARGENAME)) %>" />
<input type="hidden" name="<%=Params.DL.MAIL %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.MAIL)) %>" />
<input type="hidden" name="<%=Params.DL.CITY %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.CITY)) %>" />
<input type="hidden" name="<%=Params.DL.TEL %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.TEL)) %>" />
<input type="hidden" name="<%=Params.DL.INQUIRY %>"
  value="<%=DoText.purgeNull(request.getParameter(Params.DL.INQUIRY)) %>" />
