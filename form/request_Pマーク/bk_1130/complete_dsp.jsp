...
<title>送信完了 - 資料請求・お問合せフォーム | 株式会社カナミックネットワーク</title>
<!-- InstanceEndEditable -->
...
<div class="section mb200">
<h2><img src="../../common/img/inquiry/h2_inquiry04.gif" alt="資料請求フォームの送信が完了しました" width="600" height="45" title="資料請求フォームの送信が完了しました" /></h2>
<p>資料のご請求ありがとうございました。担当者から後日、資料をご送付させていただきますのでお待ちください。</p>
<!-- // end .section =============================--></div>
