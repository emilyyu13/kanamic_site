...
<%  /*** 画面遷移部 ***/
	...
	//画面遷移確認	if(
	String param = request.getParameter(Params.NEXT2);
    if((param != null && param.length() != 0) && Params.NEXT2.equals(param))
    {
    	//表示部の出力
	    RequestDispatcher rd = request.getRequestDispatcher("./input_dsp.jsp");
