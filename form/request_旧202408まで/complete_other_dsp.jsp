...
<div id="bredcrumbSec">
 <ul class="pkg" id="breadcrumb">
  ...
  <li class="now"><span class="itemNum">3</span>送信完了</li>
 </ul>
</div>
<div id="completeSec">
 <p>ありがとうございました。<br>
  お問合せを承りました。<br>
  <br>
  後ほど担当者からご案内させていただきます。<br>
  お急ぎのところ恐れ入りますが、ご連絡をお待ちください。
 </p>
  <div id="irReq">
...
<p class="btnN"><a href="https://www.kanamic.net/"><span>サイトトップページへ</span></a></p>
 </div>
