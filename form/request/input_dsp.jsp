...
<head>  
  ...
  <meta name="Description" content="カナミックネットワーク介護システムに関するお問合せ資料請求用フォームのページです。" />
...
<body>
  ...
  <!-- 電話でのお問合せ -->
  <a href="tel:03-3798-3955" class="phone_link">
    <div id="phoneReq">
      <p class="phone_block_txt1">お電話でのお問合せはこちら</p>
      <p class="callNumber">03-5798-3955</p>
      <p class="timeIn">受付時間：平日9時～18時</p>
      <p class="phone_small_txt">※土日祝祭日、年末年始、GW、夏季休暇時は休業となります。</p>
      <p class="phone_small_txt">※毎月10日（国保請求最終日）直前の土曜日は通常通り対応しております。</p>
    </div>
  </a>
  ...
  <header>
    <div id="thanks">
      <div class="logomark"><img src="img/logo.svg"></div>
      <p class="form_sub_title">カナミックのクラウド型ソフト</p>
      <h1>資料請求・お問合せフォーム</h1>
    </div>
  </header>
  ...
  <div id="wrapper">
    <div id="contact">
      <div id="mailReq">
        ...
        <div class="button_selection_box button_selection_title">
          <h2>お問合せの内容</h2>
        </div>

        <div class="button_selection_box button_selection_list">
          <ul>
            <li>
